                ...
                <ul class="products-cart">
                    ...
                    <li class="pr-cart-item">
                        <div class="product-image">
                            <figure><img src="{{asset('assets/images/products/'.$item->model->productImages->first()->image_name)}}" alt="{{$item->model->name}}"></figure>
                        </div>
                        ...
                        <div class="delete">
                            <a href="#" class="btn btn-delete" title="" wire:click.prevent="removeProduct('{{$item->rowId}}')">
...
{{--                    <p class="summary-info"><span class="title">Shipping</span><b class="index">Free Shipping</b></p>--}}
                ...
                <div class="update-clear">
                    <a class="btn btn-clear" href="#" wire:click.prevent="removeAll()">Clear Shopping Cart</a>
